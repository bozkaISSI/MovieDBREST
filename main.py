...
def add_actor_to_movie(movie_id: int, actor_data: schemas.ActorAdd):
    ...
    try:
        ...
        return schemas.Movie.from_orm(movie)
    except DoesNotExist:  # Handle both Movie and Actor exceptions
...
def get_actor(actor_id: int):
    ...
    except DoesNotExist:  # Handle actor not found
